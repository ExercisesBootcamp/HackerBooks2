...
@interface JARAnnotationDetailVC () <UITextFieldDelegate, UITextViewDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate>
...
@implementation JARAnnotationDetailVC
...
- (void)saveAnnotationWithCompletion:(void(^)(BOOL success, NSError *error))completionBlock {
    JARAnnotation *annotation = [JARAnnotation annotationOnBook:self.book
