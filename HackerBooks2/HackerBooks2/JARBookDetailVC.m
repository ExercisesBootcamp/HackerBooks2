...
@interface JARBookDetailVC ()

@property (nonatomic, readwrite) JARBook *book;

@end

@implementation JARBookDetailVC
...
- (IBAction)readBtnPressed:(UIButton *)sender {
    ...
    // Show pdf file
    JARSimplePDFVC *pdfVC = [[JARSimplePDFVC alloc] initWithBook:self.book];
...
- (IBAction)showAnnotationsBtnPressed:(UIButton *)sender {
    ...
    // View controller
    JARAnnotationsVC *annVC = [JARAnnotationsVC
